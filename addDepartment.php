...
<div class="col-6">
    ...
    <table>
    <form action="addingDepartment.php" method="post">
     <tr> <td> Department name:</td><td>  <input name="name" type="text"> </td><br></tr>
     <tr> <td> Department ID:</td><td> <input name="ID" type="text"></td> <br></tr>
     <tr> <td> Department Chair:</td><td> <input name="chair" type="text"></td> <br></tr>
